...
Time Complexity: O(N)O(N) where NN is the length of words, and assuming the lengths of licensePlate and words[i] are bounded by O(1)O(1).

Space Complexity: O(1)O(1) in additional space.
	 */
