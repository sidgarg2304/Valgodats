...
public class RegularExpressionMatching {
	 ...
	 * s.charAt(i) or p.charAt(i-1) == '.': dp[i][j] = dp[i-1][j] //in this case,
	 * a* counts as multiple a or dp[i][j] = dp[i][j-1] // in this case, a*
	 * counts as single a or dp[i][j] = dp[i][j-2] // in this case, a* counts as
	 * empty
	 * 
	 * @param s
	 * @param p
