 ...
 * 
 * https://leetcode.com/problems/shortest-palindrome/?tab=Solutions
 * 
...
public class ShortestPalindrome {
	 ...
	 * @return
	 */
	public static String shortestPalindromeRecursive(String s) {
		int j = 0;
		...
		return new StringBuffer(suffix).reverse().toString() + shortestPalindromeRecursive(s.substring(0, j)) + suffix;
	}
