...
public class ValidWordSquare {
	 ...
	 * @return
	 */
	public boolean validWordSquareEasy(List<String> words) {
...
/**
 * Highly Readable Code in Java Code readability is also an important aspect
 * when we are doing interviews. Split it into two functions.
 * 
 */
class SolutionHighlyReadable {
