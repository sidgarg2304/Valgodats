 ...
 * "Bronze Medal", "4", "5"] Explanation: The first three athletes got the top
...
public class RelativeRanks {
	 ...
	 * @return
	 */
	public String[] findRelativeRanksEasyUsingSortingAndTwoDimen(int[] nums) {
	...
	public String[] findRelativeRanksEasyUsingSortingAndOneDimen(int[] nums) {
