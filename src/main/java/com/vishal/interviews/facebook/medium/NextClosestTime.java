...
public class NextClosestTime {
	...
	/**
	 * Approach #1: Simulation [Accepted] Intuition and Algorithm
	 * 
	 * Simulate the clock going forward by one minute. Each time it moves
	 * forward, if all the digits are allowed, then return the current time.
	 * 
	 * The natural way to represent the time is as an integer t in the range 0 <=
	 * t < 24 * 60. Then the hours are t / 60, the minutes are t % 60, and each
	 * digit of the hours and minutes can be found by hours / 10, hours % 10 etc.
	 */
