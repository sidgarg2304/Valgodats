...
For each possible center, find the largest plus sign that could be placed by repeatedly expanding it. We expect this algorithm to be O(N^3)O(N
​3
​​ ), and so take roughly 500^3 = (1.25) * 10^8500
​3
​​ =(1.25)∗10
​8
​​  operations. This is a little bit too big for us to expect it to run in time.
	 */
	public int orderOfLargestPlusSignNaive(int N, int[][] mines) {
